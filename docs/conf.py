...
latex_documents = [
    (master_doc, 'readgssi.tex', 'readgssi Documentation',
     'Ian Nesbitt', 'manual'),
]
...
man_pages = [
    (master_doc, 'readgssi', 'readgssi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'readgssi', 'readgssi Documentation',
     author, 'readgssi', 'One line description of project.',
     'Miscellaneous'),
]
