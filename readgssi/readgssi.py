...
def readgssi(infile, outfile=None, verbose=False, antfreq=None, frmt='python',
    ...
    :rtype: header (:py:class:`dict`), radar arrays by channel :py:class:`dict` {0: :py:class:`numpy.ndarray`, 1: :py:class:`numpy.ndarray`}, gps (False or :py:class:`pandas.DataFrame`)
